...
namespace DT102G_WeightApp.Areas.Identity.Pages.Account.Manage
{
    public class DeletePersonalDataModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            // Added function to delete all entries if user is deleted
            var weightModel = _context.Weights.Where(x => x.UserName == currentId);
            _context.Weights.RemoveRange(weightModel);
